...
stage_root="${1:?usage: install_spatial_forcing_phase8_relational.sh STAGE_ROOT}"
...
install -D -m 0755 \
  "${stage_root}/scripts/run_spatial_forcing_phase8_tests_on_server.sh" \
  "${starvla_repo}/run_spatial_forcing_phase8_tests_on_server.sh"
...
echo "SPATIAL_FORCING_PHASE8_RELATIONAL_INSTALL=PASS"
