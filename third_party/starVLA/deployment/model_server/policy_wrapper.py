...
class PolicyServerWrapper:
    ...
    def metadata(self) -> Dict[str, Any]:
        ...
        if self._default_unnorm_key is not None:
            ...
            base["supports_raw_state_normalization"] = True
        return base
        ...
        **kwargs,
        ...
        if normalize_state:
            ...
            for example in examples:
                ...
                if "state" not in prepared:
                    raise ValueError("normalize_state=True requires every example to contain `state`")
                prepared["state"] = proc.apply_state(np.asarray(prepared["state"]))
        ...
        # extrapolate far beyond the robot-safe delta range.
